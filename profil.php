...
if(isset($_POST['login']) && isset($_POST['prenom']) && isset($_POST['nom']) && isset($_POST['password']) && isset($_POST['re_password'])){


  $new_login = validate($_POST['login']);
  $new_prenom = validate($_POST['prenom']);
  $new_nom = validate($_POST['nom']);
  ...
  if ($new_login !== '' && $new_prenom !== '' && $new_nom !== '' && $new_password !== '' && $new_re_password !== '') {

    // echo "login => $new_login";
    // echo "prenom => $new_prenom";
    // echo "nom => $new_nom";
...
<head>
    ...
    <title>Profile Page | module-connexion</title>
</head>
    ...
    <main class="vertical-layout centered-layout">
      ...
      <div class="container">
        ...
        <form method="post">
          ...
          <input type="text" id="prenom" name="prenom" placeholder="Prenom" value="<?= $prenom ?>" required>
       
          <input type="text" id="nom" name="nom" placeholder="Nom" value="<?= $nom ?>" required>
