...
if(isset($_POST['login']) && isset($_POST['prenom']) && isset($_POST['nom']) && isset($_POST['password']) && isset($_POST['re_password'])){
  ...
  if ($login !== '' && $prenom !== '' && $nom !== '' && $password !== '' && $re_password !== '') {
    ...
    if($password == $re_password){
      ...
      if($count == 0){ 
        ...
        $sql_new_user = "INSERT INTO utilisateurs (login, prenom, nom, password) VALUES ('$login', '$prenom', '$nom', '$password')";
...
<head>
    ...
    <title>Register Page | module-connexion</title>
</head>
